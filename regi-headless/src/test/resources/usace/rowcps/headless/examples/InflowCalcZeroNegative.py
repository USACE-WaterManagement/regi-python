...
def calculate_inflow(registry):
    ...
    # Java's Calendar.MONTH was 0-indexed (7 == August); datetime.month is
    # 1-indexed, so we use 8 here for the same date.
    ...
    inflow_calc.zeroNegatives("SWF", "ALAT2", start_date)
