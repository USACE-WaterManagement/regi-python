...
flowGroupJSPturbine1 = "Turbine1"
flowGroupJSPturbine2 = "Turbine2"
...
#compute_Single_Flowgroup(officeID, "GGLT2", startCal, endCal, "Spillway GGL_Total")
