...
def run_calculations(registry):
    ...
    #KEYS
    gateCalc.computeFlowGroup("SWT", "KEYS",  start_date, end_date, "Flow.KEYS.Project_Total")
    gateCalc.computeFlowGroup("SWT", "KEYS",  start_date, end_date, "Flow.KEYS.Turbine_Total")
    gateCalc.computeFlowGroup("SWT", "KEYS",  start_date, end_date, "Flow.KEYS.Gated_Total")
