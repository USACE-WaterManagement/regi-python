...
def run_calculations(registry):
    ...
    #MERE
    gateCalc.computeFlowGroup("SWT", "MERE",  start_date, end_date, "Flow.MERE.Project_Total")
    gateCalc.computeFlowGroup("SWT", "MERE",  start_date, end_date, "Flow.MERE.Gated_Total")
