...
def run_calculations(registry):
    ...
    # Defaults to start of the day 5 days and 7 hours ago, and ends at the top
    # of the current hour today
    ...
    #start_date_dt = start_date_dt - timedelta(days=152)  # ~5 months
    ...
    #HUDS
    gateCalc.computeFlowGroup("SWT", "HUDS",  start_date, end_date, "Flow.HUDS.Pump_Out_Total")
    gateCalc.computeFlowGroup("SWT", "HUDS",  start_date, end_date, "Flow.HUDS.Pump_In_Total")
