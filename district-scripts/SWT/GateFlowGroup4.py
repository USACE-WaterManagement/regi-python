...
def run_calculations(registry):
    ...
    #DENI
    gateCalc.computeFlowGroup("SWT", "DENI",  start_date, end_date, "Flow.DENI.Project_Total")
    gateCalc.computeFlowGroup("SWT", "DENI",  start_date, end_date, "Flow.DENI.Turbine_Total")
    gateCalc.computeFlowGroup("SWT", "DENI",  start_date, end_date, "Flow.DENI.Gated_Total")

    #PINE
    gateCalc.computeFlowGroup("SWT", "PINE",  start_date, end_date, "Flow.PINE.Project_Total")
    gateCalc.computeFlowGroup("SWT", "PINE",  start_date, end_date, "Flow.PINE.Gated_Total")

    #BROK
    gateCalc.computeFlowGroup("SWT", "BROK",  start_date, end_date, "Flow.BROK.Project_Total")
    gateCalc.computeFlowGroup("SWT", "BROK",  start_date, end_date, "Flow.BROK.Turbine_Total")
    gateCalc.computeFlowGroup("SWT", "BROK",  start_date, end_date, "Flow.BROK.Gated_Total")

    #SARD
    gateCalc.computeFlowGroup("SWT", "SARD",  start_date, end_date, "Flow.SARD.Project_Total")
    gateCalc.computeFlowGroup("SWT", "SARD",  start_date, end_date, "Flow.SARD.Gated_Total")

    #EUFA
    gateCalc.computeFlowGroup("SWT", "EUFA",  start_date, end_date, "Flow.EUFA.Project_Total")
    gateCalc.computeFlowGroup("SWT", "EUFA",  start_date, end_date, "Flow.EUFA.Turbine_Total")
    gateCalc.computeFlowGroup("SWT", "EUFA",  start_date, end_date, "Flow.EUFA.Gated_Total")
