...
| `autoAdjust(String officeId, String locationStr, Date startDate, boolean useLimits, boolean freezeRain)`               | No                      | No                       | No                     | Maybe                   | Unused overload                                      |
...
| `setComputationStorageOptions(InflowComputationStorageOption option, InflowComputationStorageOption... options)` | No                      | No                       | No                     | Maybe                   | No longer used in recent scripts or District Scripts |
